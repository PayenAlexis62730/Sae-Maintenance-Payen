...
<div style="position: absolute; top: 10px; left: 10px;">
    <?php if (isset($_SESSION['username'])): ?>
        <div>
            <button onclick="toggleMenu()"><?php echo htmlspecialchars($_SESSION['username']); ?></button>
            <div id="userMenu" style="display: none;">
				<a href="Connexion/profile.php">Voir Profil</a><br>
    ...
    <?php else: ?>
        <a href="Connexion/login.php"><button>Connexion</button></a><br>
    <?php endif; ?>
</div>
